fun main(args: Array<String>) {
    ...
    taxCents = calcTax(cardType, precedingMonthMoneyCents, transferMoneyCents)
    println("The transfer tax for ${transformBy100(transferMoneyCents)} after ${transformBy100(precedingMonthMoneyCents)} by $cardType is ${transformBy100(taxCents)}")
    ...
    transferMoneyCents = 1_000_00uL
    taxCents = calcTax(cardType, precedingMonthMoneyCents, transferMoneyCents)
    println("The transfer tax for ${transformBy100(transferMoneyCents)} by $cardType after ${transformBy100(precedingMonthMoneyCents)} is ${transformBy100(taxCents)}")
